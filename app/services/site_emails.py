...
MESSAGES = {
    "order": {
        ...
        "body_default": NL.join([
            ...
            "",
            "You can find your orders, make bookings and download your files "
            "from here where applicable:",
            "{{link}}",
            "",
    ...
    "sale": {
        ...
        "body_default": NL.join([
            "A customer made an order from your website.",
            "",
            "Please find the order from {{site}} below:",
            "",
            "{{items}}",
            "",
            "Total: {{total}}",
    ...
    "confirm": {
        ...
        "body_default": NL.join([
            ...
            "",
            "If this was you and you wish to be subscribed please opt in by "
    ...
    "subscribed": {
        ...
        "body_default": NL.join([
            ...
            "",
            "We will send you news and offers from time to time, and you can "
            "stop them whenever you like using the link at the bottom of any "
            "message.",
            "",
            "Many thanks for your interest.",
        ]),
